...
local OWNER_USER_ID = 9220706906
...
if not shared.VapeDeveloper then
	local _, subbed = pcall(function()
		return game:HttpGet('https://github.com/kiyo2007/VapeV4ForRoblox')
	end)
...
if not shared.VapeDeveloper then
	...
	commit = commit and subbed:sub(commit + 13, commit + 52) or nil
	commit = commit and #commit == 40 and commit or 'main'
	if commit == 'main' or (isfile('rise/profiles/commit.txt') and readfile('rise/profiles/commit.txt') or '') ~= commit then
		wipeFolder('rise')
...
return loadstring(downloadFile('rise/main.lua'))()
